...
//
// National team multiplier — current tier only, no compounding. U17 1.10,
// U18 1.15, U21 1.25, senior 1.40. Defaults to 1.0 when not in a national team.
// Veteran multiplier (1.15× when player has been on roster 24+ months). Applied
// here so the +15% reflects on every offer the engine ever computes.
...
// budget instead of producing absurd numbers. When state is provided, the
// run's permanent MV buff stacks on top.
